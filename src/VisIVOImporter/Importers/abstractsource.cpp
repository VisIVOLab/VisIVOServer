...
//---------------------------------------------------------------------
void AbstractSource::setPointsFileName(
    const char *fileName, const char *binaryName, const char *tableOrVolume,
    double size[], double comput[], const char *file, const char *endian,
    const char *type, const char *aliasParticle, const char *aliasHeader,
...
//---------------------------------------------------------------------
void AbstractSource::setPointsFileName(const char *fileName,
...
//---------------------------------------------------------------------
int AbstractSource::writeHistory(const char *histFile, const char *format,
                                 const char *out, const char *tableOrVolume,
                                 double comput[], double size[],
                                 const char *login, const char *binaryHeader,
                                 float missing, float text, const char *endian,
                                 const char *type, long unsigned int points,
                                 const char *vo, const char *se,
                                 const char *lfnout, const char *inputFile)
//---------------------------------------------------------------------
{
  new HistoryXmlWriter(histFile, format, out, tableOrVolume, comput, size,
                       login, binaryHeader, missing, text, endian, type, points,
                       vo, se, lfnout, inputFile);
  return 1;
}
